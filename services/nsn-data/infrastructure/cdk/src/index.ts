...
import { EntityManagementApiStack } from './nsn-data-api-stack';
 ...
 */
const stack = new EntityManagementApiStack(app, 'nsn-data-api', {
    env,
    stackName: `nsn-data-api-${SHORT_ENV}`,
});
cdk.Tags.of(stack).add('Env', SHORT_ENV.toUpperCase());
cdk.Tags.of(stack).add('ApplicationID', 'nsn-data-api');
